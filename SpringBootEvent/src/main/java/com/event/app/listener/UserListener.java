...
public class UserListener {
    ...
    public UserValidatedEvent listenUserRegisteredEvent(UserRegisteredEvent userRegisteredEvent) {
        System.out.println("LISTENING:RegisteredEvent Event has been listened -> ".concat(userRegisteredEvent.toString()));
    ...
    public void listenUserValidatedEvent(UserValidatedEvent userValidatedEvent) {
        System.out.println("LISTENING:ValidatedEvent Event has been listened -> ".concat(userValidatedEvent.toString()));
    }
