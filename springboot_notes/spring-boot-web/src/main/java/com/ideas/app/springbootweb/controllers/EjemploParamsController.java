...
public class EjemploParamsController {  //pase de datos via parametros(RequestParam en los endpoints)
...
//    otra forma pero mas complicada, mas codigo y usar trycatch en caso de uso
